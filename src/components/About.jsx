    ...
    return (
        <section id="about" className="section-padding py-20 px-6">
            <div className="container">
                <div className="flex flex-col md-flex-row items-center gap-12" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem', alignItems: 'center' }}>
                    <motion.div
                        ...
                        style={{ position: 'relative', width: '100%', maxWidth: '450px', margin: '0 auto', aspectSquare: '1/1', border: '1px solid rgba(99, 102, 241, 0.3)', borderRadius: '24px' }}
                    >
                    ...
                    >
                        <h2 className="text-4xl font-extrabold" style={{ fontSize: '2.5rem', marginBottom: '1.5rem' }}>Passion for <span className="gradient-text">Problem Solving</span></h2>
                        <p className="text-gray-400" style={{ fontSize: '1.1rem', marginBottom: '1.5rem', lineHeight: 1.8 }}>
